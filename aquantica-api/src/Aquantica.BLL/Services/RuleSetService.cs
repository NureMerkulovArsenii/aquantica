...
public class RuleSetService : IRuleSetService
{
    ...
    public async Task<bool> CreateRuleSetAsync(CreateRuleSetRequest request)
    {
        var ruleSet = new IrrigationRuleset
        {
            ...
            IrrigationDuration = TimeSpan.FromHours(1), //request.IrrigationDuration,
            ...
            RainAvoidanceDurationThreshold = TimeSpan.FromHours(1),//request.RainAvoidanceDurationThreshold,
